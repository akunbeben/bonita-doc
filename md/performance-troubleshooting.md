...
By default, any connectors longer than 10 seconds will produce a warning log. See [connector servive](performance-tuning.md#connector_service) for more information. 
